...
class StorageService {
  ...
  Future<Map<String, String>> getDeviceNames() async {
    try {
      ...
      print('Failed to get device names: $e');
      return {};
    }
  }
  ...
  Future<bool> removeDeviceName(String deviceId) async {
    try {
      ...
      print('Failed to remove device name: $e');
      return false;
    }
  }
  ...
  Future<bool> hasKey(String key) async {
    try {
      ...
      print('Failed to check if key exists: $e');
      return false;
    }
  }
  ...
  Future<bool> storePinForDevice(String deviceName, String pin) async {
    try {
      ...
      print('Failed to store PIN for device: $e');
      return false;
    }
  }
  ...
  Future<String?> getPinForDevice(String deviceName) async {
    try {
      ...
      print('Failed to retrieve PIN for device: $e');
      return null;
    }
  }
  ...
  Future<bool> removePinForDevice(String deviceName) async {
    try {
      ...
      print('Failed to remove PIN for device: $e');
      return false;
    }
  }
  ...
  Future<bool> hasStoredPin(String deviceName) async {
    try {
      ...
      print('Failed to check if device has stored PIN: $e');
      return false;
    }
  }
}
