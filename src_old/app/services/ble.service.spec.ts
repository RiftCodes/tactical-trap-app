...
import { BluetoothLE, InitParams, AdapterInfo, DeviceInfo, Device, PrevConnectionStatus,
         ScanParams, ScanStatus,
    DescriptorParams, WriteCharacteristicParams, OperationResult } from '@ionic-native/bluetooth-le/ngx';
...
export class MockBluetoothLE extends BluetoothLE {
    ...
    stopScan(): Promise<{
        ...
        return Promise.resolve({status: 'scanStopped'} as {status: 'scanStopped'});
    }
...
describe('BleServiceService', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [
                { provide: BluetoothLE, useClass: MockBluetoothLE},
            ],
        })
    });
